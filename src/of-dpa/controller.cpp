...
void controller::handle_port_status(rofl::crofdpt &dpt, const rofl::cauxid &auxid,
...
void controller::handle_acl_policy_table(rofl::crofdpt &dpt,
                                       rofl::openflow::cofmsg_packet_in &msg) {
  using rofl::openflow::cofport;
...
int controller::l2_addr_remove_all_in_vlan(uint32_t port, uint16_t vid) noexcept {
  int rv = 0;
  try {
    rofl::crofdpt &dpt = set_dpt(dptid, true);
